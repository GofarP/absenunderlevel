<div>
    <div class="table-responsive">
        ...
        <div class="float-right mb-3" style="clear: both;">
            <a href="{{ route('jenisabsensi.create') }}" class="btn btn-primary">
        ...
        <table class="table table-bordered" style="color: black;">
            ...
            <tbody>
                @forelse ($data_jenis_absensi as $item)
                    <tr>
                        ...
                        <td style="border: 1px solid; color: black;">
                            <div class="d-flex">
                                <a href="{{ route('jenisabsensi.edit',$item->id) }}" class="btn btn-warning mr-2">Edit</a>
                                <form action="{{ route('jenisabsensi.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
